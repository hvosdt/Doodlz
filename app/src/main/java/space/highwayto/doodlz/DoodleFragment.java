...
public class DoodleFragment extends Fragment {
    ...
    public void onStart(){
        super.onStart();
        enableAccelerameterListening();
    }

    public void enableAccelerameterListening(){
    ...
    public void disableAccelerometerListener(){
        SensorManager sensorManager = (SensorManager) getActivity().getSystemService(
                Context.SENSOR_SERVICE);
        sensorManager.unregisterListener(sensorEventListener, sensorManager.getDefaultSensor(
